...
2026년 봄학기 Programming Language 숙제 자동 채점기 <br>
...
```bash
git clone https://github.com/Birmjune/pl-checker
cd pl-checker
cd ./2026/hw<num>
...
- [IHIHHIHI](https://github.com/IHIHHIHI)
- All students sharing testcases
- All TAs in PL lecture

# 2026 Notice

- HW1 체커를 추가했습니다. 특히 새로운 문제들에 대한 테스트케이스를 추가하였습니다.
- HW2 체커를 추가했습니다.
- HW3 체커를 추가했습니다. 특히 수정된 K-- semantics 때문에 정답이 바뀌는 테스트케이스들을 수정하였습니다.
- HW4 ~ HW8은 작년 체커를 복사하였습니다.
